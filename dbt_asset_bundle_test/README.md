# dbt_asset_bundle_test

The 'dbt_asset_bundle_test' project was generated by using the dbt template for
...
3. Install dbt
   ...
   Run these instructions from the `dbt_asset_bundle_test` directory. We recommend making
...
`[dev yourname] dbt_asset_bundle_test_job` to your workspace.
...
When deploying to this target, note that the default job at resources/dbt_asset_bundle_test_job.yml
